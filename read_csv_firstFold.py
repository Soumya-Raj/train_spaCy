...
fields = ['Search Query']
df = pd.read_csv('ORS_serachData\\search.csv', usecols=fields, nrows=100)
df.info()
...
df_new.head()
df_new.to_json('auto_annotated_data\\auto_annotated_fold1.jsonl',orient="records", lines=True)
   
print("Annotated first fold of TRAIN_DATA using spacy_sm".format(time.time() - start))
